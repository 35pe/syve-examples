...
URL = 'http://127.0.0.1:5000/api/off/en/v1'
...
#URL = 'https://hexis.ai/api/off/en/v1'

LOCATIONS_DE = '/Users/sp/Lokal/LAB/framework/scraping/twitter/twitter_scrape_ny_state/locations.txt'
DATA_PATH = '/Users/sp/Lokal/LAB/framework/scraping/twitter/twitter_scrape_ny_state/data_291219'
SAMPLE_SIZE = 1000
...
# caution: deduplication at this stage might result in locations with very small/skewed data
